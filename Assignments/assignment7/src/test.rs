...
#[test]
fn check_string() {
    use crate::string_manipulation::_desideratum_output;
    let input1 = "jjdhid";
    let input2 = "ikjhjk";
    let input3 = "rtysgi";
    let output = _desideratum_output(input1, input2, input3);
    assert_eq!(output, "itdsgk");

    assert_eq!(_desideratum_output("abcd", "efgh", "ijkl"), "ajcl");
}
#[test]
fn _generating_substring_here() {
    use crate::task::generating_subset::_generating_substring;
    assert_eq!(
